...
export function onTurnoAsksFor(
  username_asking,
  character,
  gun,
  room,
  ...
  const has_card =
    my_cards.includes(character) ||
    my_cards.includes(gun) ||
    my_cards.includes(room);
 ...
 */
export function onTurnoShowCards(
  username_showed,
  username_shower,
  character,
  gun,
  ...
  console.log(
    `${username_shower} showed ${username_showed} ${character}, ${gun}, ${room}`
  );
